...
export default function FilmPoster({ movie, status, onClick }: Props) {
  ...
  return (
    <button
      onClick={onClick}
      className="relative flex-shrink-0 w-32 aspect-[2/3] rounded-lg overflow-hidden bg-bg-elevated border border-transparent hover:border-cinema-red transition-colors group"
    >
      {poster ? (
